...
const blogs: BlogMeta[] = [
  ...
  description: "A data-backed deep dive into why most AI projects fail — from unclear ROI frameworks to poor data readiness — and how your business can succeed with a structured AI implementation strategy."
    ...
    category: 'Guide',
    image: '/src/assets/workAuto.png',
    excerpt: "Discover how a startup slashed $75,000 in annual operating costs using custom AI automation — without replacing a single team member.",
    description: "A behind-the-scenes look at how OrbitLabs built a custom AI automation solution that saved a startup $75K annually by streamlining operations, reducing manual tasks, and improving workflow efficiency."
  }
];
