...
import { Clock, Bot, TrendingUp, Code, Check, X } from "lucide-react";
...
const ServicesPage = () => {
  ...
  return (
    <>
      <section id="services" ref={sectionRef} className="relative bg-black py-12 sm:py-16 lg:py-24 px-4 sm:px-6 overflow-hidden" style={{ zIndex: 50, position: 'relative' }}>
        ...
        <div className="flex flex-col items-center text-center px-4 sm:px-6">
          ...
          {/* Main headline */}
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-orbit-text-primary mb-6 sm:mb-8 leading-tight max-w-5xl">
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-lg md:text-xl text-orbit-text-muted max-w-3xl leading-relaxed">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
                              ...
                              {['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'].map((day, dayIndex) => (
                                <div 
                                  ...
                                  className={`
                                    ...
                                    ${(visibleCards.has(6) && dayIndex === 0) ? 'bg-purple-600' : ''}
                                  `}
                                >
                                  {day}
                                </div>
          ...
          {/* CTA Section */}
          <div className="text-center bg-gradient-to-r from-orbit-purple/10 to-orbit-purple/5 rounded-xl p-12 max-w-4xl mx-auto mt-20">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 text-orbit-text-primary">Ready to Get Started?</h2>
